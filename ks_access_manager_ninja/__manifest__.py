# -*- coding: utf-8 -*-
{
    ...
    'live_test_url': 'http://amn18demo.kappso.com/web/demo_login',
    'support': 'sales@ksolves.com',
    'version': '18.0.2.0.0',
    'website': 'https://store.ksolves.com/',
    'category': 'Services',
    'images': [
        'static/description/Access Manager Ninja Banner.png',
    ],
    'depends': ['base', 'auth_signup', 'web', 'base_setup'],
    'external_dependencies': {
        'python': ['openpyxl', 'werkzeug', 'lxml','bs4'],
    },
    'data': [
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'ks_access_manager_ninja/static/src/js/ks_switch_menu.js',
            'ks_access_manager_ninja/static/src/js/ks_spreadsheet.js',
        ],
        'web.assets_frontend': [
