...
""",
    ...
    'live_test_url': 'https://ganttview18.kappso.com/web/demo_login',
    ...
    'images': ['static/description/v18.jpg'],

    'data': ['views/ks_res_config_settings_view.xml', 'data/week_days_data.xml', 'security/ir.model.access.csv'],

    'external_dependencies': {
        'python': ['pandas', 'openpyxl']
    },

    'assets': {'web.assets_backend': ['ks_gantt_view_base/static/src/scss/ks_mixins.scss',
